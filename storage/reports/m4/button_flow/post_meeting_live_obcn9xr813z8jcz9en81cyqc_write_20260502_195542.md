...
- summary_card: `MeetFlow 会后总结：妙计测试2`，elements=`9`
- pending_card: 未发送候选（没有待确认任务）

## 6.1 相关背景资料

- related_knowledge_status: `hit`
- related_knowledge_query: 妙计测试2 meetflow
- related_knowledge_hit_count: `1`
  - `kref_fff0c1de1ed47e49` MeetFlow M3 会前知识卡片方案 score=`0.95` url=https://example.feishu.cn/docx/workflow_demo_m3_rag
...
- skipped_tasks: `0`
- sent_cards: `1`
  - summary_card: status=`success`, message_id=`om_x100b506a2d2b44acb4b4697e91e4af1`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
