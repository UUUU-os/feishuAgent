...
- pending_card: `MeetFlow 待确认任务`，elements=`12`
...
- sent_cards: `4`
  - summary_card: status=`success`, message_id=`om_x100b506a64c3d8a0b4caf78ec71cfa7`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
  - pending_button_card: status=`success`, message_id=`om_x100b506a64db2ca0b3ec24b4c3284a9`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
  - pending_button_card: status=`success`, message_id=`om_x100b506a64ed80a8b25343179dd7827`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
  - pending_button_card: status=`success`, message_id=`om_x100b506a64e4f4a4b26ae891032d12a`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`

## 8. 结论

本次发送 4 张卡片；3 个 Action Item 进入待确认，未自动创建任务。
