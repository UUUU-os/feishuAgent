...
- sent_cards: `5`
  - summary_card: status=`success`, message_id=`om_x100b5071120f5ca0b3c52a771ee63cf`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
  - pending_card: status=`success`, message_id=`om_x100b50711207fca4b2a752497e5dd92`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
  - pending_reaction_message: status=`success`, message_id=`om_x100b5071121ee4a8b291a381fdeaf78`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
  - pending_reaction_message: status=`success`, message_id=`om_x100b50711216aca0b245abd26b76e71`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`
  - pending_reaction_message: status=`success`, message_id=`om_x100b5071122e9ca0b486e87cdae9660`, chat_id=`oc_3e432398cc43063fda2b2d322bb6dead`

## 8. 结论

本次发送 5 张卡片；3 个 Action Item 进入待确认，未自动创建任务。
