  ...
  "hits": [
    {
      ...
      "reason": "混合命中 final_score:0.761；向量召回:0.83；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛-线上开赛仪式；命中查询词:meetflow；包含回链定位；关键词召回:0.74；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛-线上开赛仪式；命中查询词:meetflow；包含回链定位",
      "score": 0.761,
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.538；向量召回:0.58；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.54；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.538,
      "vector_similarity": 0.576,
      "term_similarity": 0.544,
      "rerank_score": 0.0,
      "final_score": 0.538,
