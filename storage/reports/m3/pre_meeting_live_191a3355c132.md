...
```json
{
  ...
  "hits": [
    {
      ...
      "source_type": "doc",
      "title": "李健文-个人阶段小结",
      "snippet": "...一个功能、一段代码、一个工作流、一篇踩坑记录……不限形式</em></p></blockquote><p></p><p>飞书客户端的搭建。能够通过飞书api获取到用户的日程、文档等信息。</p><p></p><h3>二、量化指标 （必...",
      "reason": "混合命中 final_score:0.527；向量召回:0.57；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.51；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.527,
      "vector_similarity": 0.574,
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.391；向量召回:0.45；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.33；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.391,
      "vector_similarity": 0.451,
      "term_similarity": 0.327,
      "rerank_score": 0.0,
      "final_score": 0.391,
      "source_url": "https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig",
      "source_locator": "doc:chunk:1",
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.344；向量召回:0.38；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.33；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.344,
      "vector_similarity": 0.378,
      "term_similarity": 0.327,
      "rerank_score": 0.0,
      "final_score": 0.344,
      "source_url": "https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig",
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.326；向量召回:0.37；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.326,
      "vector_similarity": 0.371,
      "term_similarity": 0.283,
      "rerank_score": 0.0,
      "final_score": 0.326,
      "source_url": "https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig",
      "source_locator": "doc:chunk:6",
  ...
  "reason": "混合检索候选 8 条；向量命中 8 条；关键词命中 20 条；最终返回 4 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
...
```json
{
  ...
  "hits": [
    {
      ...
      "title": "李健文-个人阶段小结",
      "snippet": "...一个功能、一段代码、一个工作流、一篇踩坑记录……不限形式</em></p></blockquote><p></p><p>飞书客户端的搭建。能够通过飞书api获取到用户的日程、文档等信息。</p><p></p><h3>二、量化指标 （必...",
      "reason": "混合命中 final_score:0.526；向量召回:0.57；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.51；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.526,
    ...
    },
    {
      ...
      "title": "Trae IDE 模型配置指南",
      "snippet": "背景介绍 本指南旨在帮助同学们快速掌握在 Trae IDE 中配置自定义大语言模型（LLM）的方法。通过配置自定义模型，你可以根据学习需求灵活切换不同的 AI 服务，提升编程效率。",
      "reason": "混合命中 final_score:0.393；向量召回:0.45；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.33；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.393,
      "vector_similarity": 0.454,
      "term_similarity": 0.327,
      "rerank_score": 0.0,
      "final_score": 0.393,
      "source_url": "https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig",
    ...
    },
    {
      ...
      "title": "Trae IDE 模型配置指南",
      "snippet": "3. 测试与确认 配置完成后，你可以通过以下方式验证是否成功： 打开 Trae IDE 的 AI 聊天窗口 (Chat)。 在模型下拉菜单中选择你刚刚配置的 自定义模型 。 输入一个简单的问题（例如：“你好，请介绍一下你自己”），观察模型是否能正常回复。 如果模型能...",
      "reason": "混合命中 final_score:0.350；向量召回:0.39；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.33；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.35,
    ...
    },
    {
      ...
      "title": "Trae IDE 模型配置指南",
      "snippet": "步骤三：添加并配置自定义模型 在模型配置界面中，找到“自定义模型”或“添加模型”按钮，并根据提示填入你准备好的信息： Endpoint : 选择火山引擎 - 自定义模型 Model ID : 填入对应的模型标识符。（请用自行认领的 ） API Key : 填入导师提供...",
      "reason": "混合命中 final_score:0.325；向量召回:0.37；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.325,
      "vector_similarity": 0.369,
      "term_similarity": 0.283,
      "rerank_score": 0.0,
      "final_score": 0.325,
      "source_url": "https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig",
  ...
  "embedding_dimensions": 512,
  "low_confidence": false,
  "reason": "混合检索候选 12 条；向量命中 8 条；关键词命中 20 条；最终返回 4 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```

### im.send_card `blocked`

```json
{
  "policy_decision": {
    "status": "blocked",
    "reason": "同一写操作幂等键已处理，跳过重复执行：pre_meeting_brief:b9c6ca7b-c1dd-4f1a-b995-edf71f3faa7c_0",
    "tool_name": "im.send_card",
    "idempotency_key": "pre_meeting_brief:b9c6ca7b-c1dd-4f1a-b995-edf71f3faa7c_0",
    "patched_arguments": {
      "title": "📋 会前背景：飞书 AI 校园竞赛-主题分享直播-产品专场",
      "summary": "本次会议是「飞书 AI 校园挑战赛」系列直播中的产品专场主题分享。以下为基于已有资料整理的背景信息。",
      "facts": [
        {
          "label": "📅 会议时间",
          "value": "2026-04-29 18:00 (Unix: 1777456800)"
        },
        {
          "label": "🏆 赛事背景",
          "value": "飞书 AI 校园挑战赛（4月22日-5月14日），面向全国高校学生，聚焦AI场景化应用落地，设置多元赛道。获奖可瓜分8万元总现金奖池，优秀选手可获得校招实习/正式Offer机会。"
        },
        {
          "label": "📄 已有索引资源",
          "value": "① 飞书 AI 校园挑战赛-线上开赛仪式（来源：https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh）\n② Trae IDE 模型配置指南（来源：https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig）"
        },
        {
          "label": "🔍 产品专场相关线索",
          "value": "⚠️ 知识库中未找到专门针对本次「产品专场」的详细议程文档。以下为「线上开赛仪式」中与产品相关的内容，属于可能相关资料："
        },
        {
          "label": "🧠 飞书AI产品能力（开赛仪式资料）",
          "value": "飞书AI产品矩阵包括：①飞书知识问答（企业AI大脑）②飞书智能会议纪要（图文并茂）③多维表格·AI系统搭建④飞书aily（智能伙伴）⑤飞书aily专业版⑥飞书妙搭（AI Coding工具）⑦OpenClaw飞书官方插件⑧AnyGen×Lark（全球化）。来源：开赛仪式文档"
        },
        {
          "label": "🛠️ 开发资源（开赛仪式资料）",
          "value": "赛事提供：大模型Token（Doubao 1.6，单人TPM 1w）、飞书API无限调用额度、飞书妙搭、OpenClaw一键部署、GitHub代码仓库。需完成Trae IDE模型配置（参考Trae IDE模型配置指南）。来源：开赛仪式文档"
        },
        {
          "label": "🎤 技术嘉宾分享参考",
          "value": "开赛仪式中技术嘉宾黄梦轩（飞书研发工程师，负责飞书MCP/CLI等AI开放能力建设）分享了《飞书AI-friendly分享》，探讨飞书平台能力与Agent/MCP/工具调用的结合。来源：开赛仪式文档"
        },
        {
          "label": "⚠️ 证据说明",
          "value": "本次会议标题为「产品专场」，但知识库中无该专场的独立议程文档。以上信息均来自关联的「线上开赛仪式」文档和「Trae IDE模型配置指南」，属于可能相关资料，非本次会议的确定性议程。建议会中补充记录。"
        }
      ],
      "idempotency_key": "pre_meeting_brief:b9c6ca7b-c1dd-4f1a-b995-edf71f3faa7c_0"
    },
...
- status: `success`
- trace_id: `191a3355c132`

```text
卡片已成功发送（幂等键已存在，说明之前已发送过，本次跳过重复发送）。以下是生成的会前背景知识卡片内容摘要：

---

## 📋 会前背景：飞书 AI 校园竞赛-主题分享直播-产品专场

### 📅 会议信息
- **会议名称**：飞书 AI 校园竞赛-主题分享直播-产品专场
- **会议时间**：2026-04-29 18:00（Unix: 1777456800）
- **参会人数**：1人（资源型参会者）

### 📄 已有索引资源
1. **飞书 AI 校园挑战赛-线上开赛仪式** — 来源：[Wiki文档](https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh)
2. **Trae IDE 模型配置指南** — 来源：[文档](https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig)

### 🔍 核心发现（基于已有资料）

| 维度 | 内容 |
|------|------|
| **赛事背景** | 飞书 AI 校园挑战赛（4月22日-5月14日），面向全国高校学生，聚焦AI场景化应用落地。获奖可瓜分8万元总现金奖池，优秀选手可获得校招实习/正式Offer机会。 |
| **飞书AI产品矩阵**（开赛仪式资料） | ①飞书知识问答 ②飞书智能会议纪要 ③多维表格·AI系统搭建 ④飞书aily ⑤飞书aily专业版 ⑥飞书妙搭 ⑦OpenClaw插件 ⑧AnyGen×Lark |
| **开发资源** | 大模型Token（Doubao 1.6）、飞书API无限调用额度、飞书妙搭、OpenClaw一键部署 |
| **技术嘉宾参考** | 开赛仪式中黄梦轩（飞书研发工程师）分享了《飞书AI-friendly分享》，涉及飞书MCP/CLI等AI开放能力 |

### ⚠️ 证据说明
本次会议标题为「**产品专场**」，但知识库中**没有该专场的独立议程文档**。以上信息均来自关联的「线上开赛仪式」文档和「Trae IDE 模型配置指南」，属于**可能相关资料**，非本次会议的确定性议程。建议会中补充记录产品专场的具体内容。
```
