...
```json
{
  ...
  "hits": [
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.391；向量召回:0.45；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.391,
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.344；向量召回:0.38；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.344,
  ...
  "reason": "混合检索候选 8 条；向量命中 8 条；关键词命中 10 条；最终返回 3 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
...
```json
{
  ...
  "hits": [
    {
      ...
      "title": "李健文-个人阶段小结",
      "snippet": "...一个功能、一段代码、一个工作流、一篇踩坑记录……不限形式</em></p></blockquote><p></p><p>飞书客户端的搭建。能够通过飞书api获取到用户的日程、文档等信息。</p><p></p><h3>二、量化指标 （必...",
      "reason": "混合命中 final_score:0.527；向量召回:0.57；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.527,
      "vector_similarity": 0.575,
      "term_similarity": 0.512,
      "rerank_score": 0.0,
      "final_score": 0.527,
      "source_url": "https://jcneyh7qlo8i.feishu.cn/wiki/D067w8sC4iYsjjk7nnAcMEXqnwb",
    ...
    },
    {
      ...
      "title": "Trae IDE 模型配置指南",
      "snippet": "背景介绍 本指南旨在帮助同学们快速掌握在 Trae IDE 中配置自定义大语言模型（LLM）的方法。通过配置自定义模型，你可以根据学习需求灵活切换不同的 AI 服务，提升编程效率。",
      "reason": "混合命中 final_score:0.389；向量召回:0.45；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.389,
      "vector_similarity": 0.448,
      "term_similarity": 0.327,
      "rerank_score": 0.0,
      "final_score": 0.389,
      "source_url": "https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig",
    ...
    },
    {
      ...
      "title": "Trae IDE 模型配置指南",
      "snippet": "3. 测试与确认 配置完成后，你可以通过以下方式验证是否成功： 打开 Trae IDE 的 AI 聊天窗口 (Chat)。 在模型下拉菜单中选择你刚刚配置的 自定义模型 。 输入一个简单的问题（例如：“你好，请介绍一下你自己”），观察模型是否能正常回复。 如果模型能...",
      "reason": "混合命中 final_score:0.348；向量召回:0.39；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.348,
      "vector_similarity": 0.385,
      "term_similarity": 0.327,
      "rerank_score": 0.0,
      "final_score": 0.348,
      "source_url": "https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig",
  ...
  "embedding_dimensions": 512,
  "low_confidence": false,
  "reason": "混合检索候选 11 条；向量命中 8 条；关键词命中 10 条；最终返回 3 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
...
{
  "body": {
    "content": "{\"title\":\"📋 会前背景知识：飞书 AI 校园竞赛-主题分享直播-产品专场\",\"elements\":[[{\"tag\":\"text\",\"text\":\"本次会议为「飞书 AI 校园挑战赛」系列中的产品专场主题分享直播。以下基于关联文档整理的核心背景知识。\"}],[{\"tag\":\"text\",\"text\":\"- 📌 \"},{\"tag\":\"text\",\"text\":\"赛事背景\"},{\"tag\":\"text\",\"text\":\"（来源：飞书 AI 校园挑战赛-线上开赛仪式）\\n飞书 AI 校园挑战赛是飞书打造的面向全国高校学生的 AI 实战挑战赛，聚焦 AI 场景化应用落地，设置多元赛道。赛事时间：4月22日-5月14日。优秀选手可获得校招实习/正式 Offer 机会，获奖可瓜分 8 万元总现金奖池。\\n- 🎯 \"},{\"tag\":\"text\",\"text\":\"产品专场定位\"},{\"tag\":\"text\",\"text\":\"（来源：会议标题 + 开赛仪式文档）\\n本次为「产品专场」主题分享直播。在开赛仪式中，飞书介绍了丰富的 AI 产品能力矩阵，包括：飞书知识问答、智能会议纪要、多维表格 AI 系统搭建、飞书 aily（智能伙伴）、飞书妙搭（AI Coding 工具）、OpenClaw 插件等。产品专场预计将深入讲解这些飞书 AI 产品的使用与场景落地。\\n- 🛠️ \"},{\"tag\":\"text\",\"text\":\"开发资源与环境\"},{\"tag\":\"text\",\"text\":\"（来源：开赛仪式文档 + Trae IDE 模型配置指南）\\n参赛者可获得：大模型 Token（Doubao 1.6，单人 TPM 1w）、飞书 API 无限调用额度、飞书妙搭、OpenClaw 等资源。需在 Trae IDE 中配置自定义模型（火山引擎 Endpoint + 模型 ID + API Key）。\\n- 📅 \"},{\"tag\":\"text\",\"text\":\"会议时间\"},{\"tag\":\"text\",\"text\":\"\\n开始时间：2026-04-29（Unix 时间戳 1777456800），时长约 1 小时。\\n- ⚠️ \"},{\"tag\":\"text\",\"text\":\"证据说明\"},{\"tag\":\"text\",\"text\":\"\\n本次会议为「产品专场」，但关联资源中暂无该专场的独立议程文档。以上信息主要来源于「飞书 AI 校园挑战赛-线上开赛仪式」文档和「Trae IDE 模型配置指南」，部分内容为基于会议标题的合理推断，建议以直播实际内容为准。\"}]]}"
  },
  "chat_id": "oc_3e432398cc43063fda2b2d322bb6dead",
  "create_time": "1777459058351",
  "deleted": false,
  "message_id": "om_x100b5029b9ec10b0c3c753ae253f142",
...
### 📋 会前背景知识：飞书 AI 校园竞赛-主题分享直播-产品专场

**会议信息**：本次会议为「飞书 AI 校园挑战赛」系列中的产品专场主题分享直播，开始时间约 2026-04-29，时长约 1 小时。

**卡片包含以下事实（均标注来源）：**

| 项目 | 内容 | 来源 |
|------|------|------|
| 📌 **赛事背景** | 飞书 AI 校园挑战赛，面向全国高校学生，4月22日-5月14日，优秀选手可获校招Offer，总奖池8万元 | 飞书 AI 校园挑战赛-线上开赛仪式 |
| 🎯 **产品专场定位** | 本次为产品专场，飞书AI产品矩阵包括：知识问答、智能会议纪要、多维表格AI、aily、妙搭、OpenClaw等 | 会议标题 + 开赛仪式文档 |
| 🛠️ **开发资源** | Doubao 1.6 大模型 Token（TPM 1w）、飞书API无限额度、Trae IDE 模型配置指南 | 开赛仪式文档 + Trae IDE 模型配置指南 |
| ⚠️ **证据说明** | 暂无该专场的独立议程文档，部分内容为基于会议标题的合理推断 | — |

> **注意**：由于关联资源中暂无「产品专场」的独立议程文档，卡片中关于专场具体内容的描述为基于开赛仪式文档的合理推断，建议以直播实际内容为准。
```
