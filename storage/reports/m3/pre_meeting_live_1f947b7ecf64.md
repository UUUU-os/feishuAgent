...
```json
{
  "query": "飞书 AI 校园竞赛 产品专场 主题分享",
  "hits": [
    {
      "ref_id": "kref_5d7c765977476882",
      "chunk_id": "Eq0ywVPwdirCLakfBeucCwKWnoh#chunk_4_4afac6ed53b3",
      "document_id": "Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_type": "doc",
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "「飞书 AI 校园挑战赛」-赛事介绍 飞书打造的 AI 实战挑战赛，面向全国高校学生开放，立足真实 AI 办公业务场景，搭建实战平台。 大赛聚焦 AI 的场景化应用落地，设置多元赛道：既深耕飞书生态内的办公协同、业务提效实践，也鼓励面向全域场景的 AI 创新探索...",
      "reason": "混合命中 final_score:0.671；向量召回:0.80；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接；关键词召回:0.51；命中查询词:飞书；命中查询词:ai；命中查询词:meetflow；包含回链定位；包含来源链接",
      "score": 0.671,
      "vector_similarity": 0.796,
      "term_similarity": 0.512,
      "rerank_score": 0.0,
      "final_score": 0.671,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:4",
    ...
    {
      "ref_id": "kref_926e9f270ae19e5b",
      "chunk_id": "Eq0ywVPwdirCLakfBeucCwKWnoh#chunk_10_66114798cbc6",
      "document_id": "Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_type": "doc",
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "飞书技术嘉宾主题分享——《飞书 AI-friendly 分享》（嘉宾：黄梦轩） 在进入实战赛道之前，我们先用一段 技术嘉宾分享 ，帮助大家建立对“飞书为什么是 AI-friendly”的整体认知： AI 时代做一个真正有价值的应用，不只是“多一个能回答问...",
      "reason": "混合命中 final_score:0.636；向量召回:0.66；命中查询词:飞书；命中查询词:ai；命中查询词:主题分享；命中查询词:meetflow；包含回链定位；关键词召回:0.70；命中查询词:飞书；命中查询词:ai；命中查询词:主题分享；命中查询词:meetflow；包含回链定位",
      "score": 0.636,
      "vector_similarity": 0.656,
      "term_similarity": 0.697,
      "rerank_score": 0.0,
      "final_score": 0.636,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:10",
      ...
      "metadata": {
        ...
        "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
        "source_type": "doc",
        "heading": "飞书技术嘉宾主题分享——《飞书 AI-friendly 分享》（嘉宾：黄梦轩）",
        "toc_path": [
          "飞书技术嘉宾主题分享——《飞书 AI-friendly 分享》（嘉宾：黄梦轩）"
        ],
        "block_types": [
  ...
  "reason": "混合检索候选 10 条；向量命中 10 条；关键词命中 10 条；最终返回 2 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
...
```json
{
  ...
  "hits": [
    {
      ...
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "「飞书 AI 校园挑战赛」-赛事介绍 飞书打造的 AI 实战挑战赛，面向全国高校学生开放，立足真实 AI 办公业务场景，搭建实战平台。 大赛聚焦 AI 的场景化应用落地，设置多元赛道：既深耕飞书生态内的办公协同、业务提效实践，也鼓励面向全域场景的 AI 创新探索...",
      "reason": "混合命中 final_score:0.823；向量召回:0.84；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:产品；命中查询词:分享；关键词召回:0.93；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:产品；命中查询词:分享",
      "score": 0.823,
      "vector_similarity": 0.836,
      "term_similarity": 0.932,
      "rerank_score": 0.0,
      "final_score": 0.823,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:4",
    ...
    {
      "ref_id": "kref_b159bb93389a3959",
      "chunk_id": "Eq0ywVPwdirCLakfBeucCwKWnoh#chunk_1_cd6826a2fa4e",
      "document_id": "Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_type": "doc",
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "开赛仪式流程总览 飞书介绍（6–8min） ：飞书是什么？飞书 AI 相关产品介绍 赛事介绍（6–8min） ：参赛收获、赛程安排、赛事支持 技术嘉宾分享（约 25min） ：《飞书 AI-friendly 分享》飞书技术专家@黄同学 资源与环境配置（10min...",
      "reason": "混合命中 final_score:0.771；向量召回:0.73；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:产品；命中查询词:分享；关键词召回:0.98；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:产品；命中查询词:分享",
      "score": 0.771,
      "vector_similarity": 0.735,
      "term_similarity": 0.976,
      "rerank_score": 0.0,
      "final_score": 0.771,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:1",
  ...
  "embedding_dimensions": 512,
  "low_confidence": false,
  "reason": "混合检索候选 12 条；向量命中 10 条；关键词命中 10 条；最终返回 2 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
...
```json
{
  "query": "飞书 AI 校园挑战赛 产品专场 直播 主题分享 产品经理",
  "hits": [
    {
      "ref_id": "kref_5d7c765977476882",
      "chunk_id": "Eq0ywVPwdirCLakfBeucCwKWnoh#chunk_4_4afac6ed53b3",
      ...
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "「飞书 AI 校园挑战赛」-赛事介绍 飞书打造的 AI 实战挑战赛，面向全国高校学生开放，立足真实 AI 办公业务场景，搭建实战平台。 大赛聚焦 AI 的场景化应用落地，设置多元赛道：既深耕飞书生态内的办公协同、业务提效实践，也鼓励面向全域场景的 AI 创新探索...",
      "reason": "混合命中 final_score:0.709；向量召回:0.80；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位；关键词召回:0.64；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位",
      "score": 0.709,
      "vector_similarity": 0.796,
      "term_similarity": 0.64,
      "rerank_score": 0.0,
      "final_score": 0.709,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:4",
    ...
    },
    {
      ...
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "飞书技术嘉宾主题分享——《飞书 AI-friendly 分享》（嘉宾：黄梦轩） 在进入实战赛道之前，我们先用一段 技术嘉宾分享 ，帮助大家建立对“飞书为什么是 AI-friendly”的整体认知： AI 时代做一个真正有价值的应用，不只是“多一个能回答问...",
      "reason": "混合命中 final_score:0.653；向量召回:0.65；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:主题分享；命中查询词:meetflow；关键词召回:0.77；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:主题分享；命中查询词:meetflow",
      "score": 0.653,
      "vector_similarity": 0.65,
      "term_similarity": 0.767,
      "rerank_score": 0.0,
      "final_score": 0.653,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:10",
  ...
  "embedding_dimensions": 512,
  "low_confidence": false,
  "reason": "混合检索候选 12 条；向量命中 10 条；关键词命中 10 条；最终返回 2 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 6 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
...
```json
{
  "query": "飞书 AI 校园挑战赛 产品赛道 参赛指南 产品设计",
  "hits": [
    {
      "ref_id": "kref_5d7c765977476882",
      "chunk_id": "Eq0ywVPwdirCLakfBeucCwKWnoh#chunk_4_4afac6ed53b3",
      ...
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "「飞书 AI 校园挑战赛」-赛事介绍 飞书打造的 AI 实战挑战赛，面向全国高校学生开放，立足真实 AI 办公业务场景，搭建实战平台。 大赛聚焦 AI 的场景化应用落地，设置多元赛道：既深耕飞书生态内的办公协同、业务提效实践，也鼓励面向全域场景的 AI 创新探索...",
      "reason": "混合命中 final_score:0.727；向量召回:0.81；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位；关键词召回:0.67；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位",
      "score": 0.727,
      "vector_similarity": 0.811,
      "term_similarity": 0.665,
      "rerank_score": 0.0,
      "final_score": 0.727,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:4",
    ...
    },
    {
      ...
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "开赛仪式流程总览 飞书介绍（6–8min） ：飞书是什么？飞书 AI 相关产品介绍 赛事介绍（6–8min） ：参赛收获、赛程安排、赛事支持 技术嘉宾分享（约 25min） ：《飞书 AI-friendly 分享》飞书技术专家@黄同学 资源与环境配置（10min...",
      "reason": "混合命中 final_score:0.652；向量召回:0.72；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位；关键词召回:0.62；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位",
      "score": 0.652,
      "vector_similarity": 0.717,
      "term_similarity": 0.621,
      "rerank_score": 0.0,
      "final_score": 0.652,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:1",
  ...
  "embedding_dimensions": 512,
  "low_confidence": false,
  "reason": "混合检索候选 11 条；向量命中 10 条；关键词命中 10 条；最终返回 2 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 6 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
...
```json
{
  ...
  "source_type": "doc",
  "title": "飞书 AI 校园挑战赛-线上开赛仪式",
  "text": "飞书技术嘉宾主题分享——《飞书 AI-friendly 分享》（嘉宾：黄梦轩）\n在进入实战赛道之前，我们先用一段 技术嘉宾分享 ，帮助大家建立对“飞书为什么是 AI-friendly”的整体认知：\nAI 时代做一个真正有价值的应用，不只是“多一个能回答问题的入口”，更关键是 能调用平台能力、参与协作、形成闭环 。\n在飞书的协作与业务场景里，哪些能力最适合与 Agent / MCP / 工具调用结合？\n从“想法”到“可运行 demo”，如何更高效地推进？\n嘉宾介绍｜黄梦轩\n飞书研发工程师（Lark App-Core Services）\n大三开始在飞书实习，校招加入飞书至今约 6 年\n当前主要负责：飞书面向 AI 的开放性与友好能力建设（包含飞书 MCP / CLI 等方向的实践）\n嘉宾 PPT（演示入口）\n嘉宾 PPT： https://bytedance.larkoffice.com/wiki/SuPrw0FRhi1Ctmkh2IUcA1fxnQc",
  "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
  "source_locator": "doc:chunk:10",
  "parent_chunk_id": "",
  "parent_text": "",
...
```json
{
  "query": "飞书 AI 校园挑战赛 产品专场 直播分享 产品赛道",
  "hits": [
    {
      "ref_id": "kref_5d7c765977476882",
      "chunk_id": "Eq0ywVPwdirCLakfBeucCwKWnoh#chunk_4_4afac6ed53b3",
      ...
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "「飞书 AI 校园挑战赛」-赛事介绍 飞书打造的 AI 实战挑战赛，面向全国高校学生开放，立足真实 AI 办公业务场景，搭建实战平台。 大赛聚焦 AI 的场景化应用落地，设置多元赛道：既深耕飞书生态内的办公协同、业务提效实践，也鼓励面向全域场景的 AI 创新探索...",
      "reason": "混合命中 final_score:0.737；向量召回:0.83；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位；关键词召回:0.67；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位",
      "score": 0.737,
      "vector_similarity": 0.827,
      "term_similarity": 0.665,
      "rerank_score": 0.0,
      "final_score": 0.737,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
    ...
    },
    {
      ...
      "title": "飞书 AI 校园挑战赛-线上开赛仪式",
      "snippet": "开赛仪式流程总览 飞书介绍（6–8min） ：飞书是什么？飞书 AI 相关产品介绍 赛事介绍（6–8min） ：参赛收获、赛程安排、赛事支持 技术嘉宾分享（约 25min） ：《飞书 AI-friendly 分享》飞书技术专家@黄同学 资源与环境配置（10min...",
      "reason": "混合命中 final_score:0.656；向量召回:0.72；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位；关键词召回:0.62；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛；命中查询词:meetflow；包含回链定位",
      "score": 0.656,
      "vector_similarity": 0.723,
      "term_similarity": 0.621,
      "rerank_score": 0.0,
      "final_score": 0.656,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
...
- status: `success`
- trace_id: `1f947b7ecf64`

```text
现在我已经收集了足够的资料。让我整理会前知识卡片草案。

---

# 📋 会前背景知识卡片草案

**会议名称**：飞书 AI 校园竞赛-主题分享直播-产品专场  
**会议时间**：2026年4月29日（Unix 时间戳 1777456800）  
**参会人数**：1 人（资源型会议室）  
**会议描述**：无  
**工作流**：pre_meeting_brief（只读联调，不发送真实卡片）
...
### 1.1 赛事简介
**飞书 AI 校园挑战赛**是飞书打造的面向全国高校学生的 AI 实战挑战赛，立足真实 AI 办公业务场景，搭建实战平台。大赛聚焦 AI 的场景化应用落地，设置多元赛道：既深耕飞书生态内的办公协同、业务提效实践，也鼓励面向全域场景的 AI 创新探索。赛事时间：**4 月 22 日 - 5 月 14 日**，决赛为 5 月 14 日线上路演。

> **来源**：飞书 AI 校园挑战赛-线上开赛仪式文档（[链接](https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh)）

### 1.2 参赛收获
- 优秀选手可获得校招实习/校招正式 Offer 机会（不与决赛排名强绑定，综合评估全程表现）
- 免费开发资源（火山方舟 Coding 豪华套餐 + 飞书 API 无限调用额度）
- 获奖可瓜分 8 万元总现金奖池，一等奖 2 万元现金
...
本次产品专场直播的核心背景——飞书在 AI 时代释放的 AI 能力，也是参赛者可探索的平台能力：

| 能力 | 说明 |
|------|------|
| **飞书知识问答** | 企业的"AI 大脑"，一问即答 |
| **飞书智能会议纪要** | 纪要图文并茂，图表画龙点睛 |
| **多维表格·AI 系统搭建** | 懂业务、会执行、能落地 |
| **飞书 aily / aily 专业版** | 每个人的智能伙伴，好上手、超能干 |
| **飞书妙搭** | 懂开发的智能伙伴，业务系统"当天想、当天用" |
| **OpenClaw 飞书官方插件** | 工程师首选，一键安装、免配置、全功能 |

> **来源**：同上文档（"🚀 飞书，让每个人都拥有自己的 AI 智能伙伴"章节）

---

## 三、与本次"产品专场"相关的可能资料

### 3.1 开赛仪式中的技术嘉宾分享（参考线索）
开赛仪式中包含一场技术嘉宾分享——《飞书 AI-friendly 分享》，嘉宾为飞书研发工程师**黄梦轩**（大三开始在飞书实习，校招加入飞书约 6 年，当前负责飞书面向 AI 的开放性与友好能力建设，包含飞书 MCP/CLI 等方向）。分享核心议题：
- AI 时代真正有价值的应用：不只是"多一个能回答问题的入口"，关键是**能调用平台能力、参与协作、形成闭环**
- 飞书协作与业务场景中，哪些能力最适合与 Agent / MCP / 工具调用结合
- 从"想法"到"可运行 demo"的高效推进路径

> **来源**：飞书 AI 校园挑战赛-线上开赛仪式文档（"飞书技术嘉宾主题分享"章节，[展开片段](https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh)）

> ⚠️ **注意**：上述为开赛仪式中的技术分享内容，本次会议为"产品专场"直播，主题和嘉宾可能不同，以上仅作为**可能相关资料**参考。

### 3.2 Trae IDE 模型配置指南（开发环境参考）
参赛者需在 Trae IDE 中配置自定义大语言模型（LLM），使用火山引擎提供的 Doubao 1.6 模型（单人 TPM 1w 额度）。配置需准备：接入点（Endpoint，选火山引擎-自定义模型）、模型 ID、API Key。

> **来源**：Trae IDE 模型配置指南文档（[链接](https://bytedance.larkoffice.com/docx/KlW9dIlyzo17ccxl26Gc9TGsnig)）

---

## 四、证据不足/待补充说明

1. **"产品专场"的具体内容缺失**：当前知识索引中未检索到本次"产品专场"直播的独立文档、议程或嘉宾信息。会议描述为空，无法确定本次直播的具体主题、分享嘉宾、议程安排。
2. **产品赛道详细规则缺失**：开赛仪式文档提到"设置多元赛道"，但未详细说明产品赛道的具体参赛要求、评审标准或作品提交规范。
3. **无历史会议纪要或任务关联**：当前会议无关...
```
