...
```json
{
  "query": "飞书 AI 校园竞赛-主题分享直播-产品专场 飞书 AI 校园挑战赛-线上开赛仪式 Trae IDE 模型配置指南",
  "hits": [
    {
      ...
      "reason": "混合命中 final_score:0.738；向量召回:0.80；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛-线上开赛仪式；命中查询词:ide；命中查询词:meetflow",
      "score": 0.738,
      "vector_similarity": 0.801,
      "term_similarity": 0.723,
      "rerank_score": 0.0,
      "final_score": 0.738,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
      "source_locator": "doc:chunk:4",
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.714；向量召回:0.77；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛-线上开赛仪式；命中查询词:ide；命中查询词:meetflow",
      "score": 0.714,
      "vector_similarity": 0.765,
      "term_similarity": 0.723,
      "rerank_score": 0.0,
      "final_score": 0.714,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
  ...
  "reason": "混合检索候选 6 条；向量命中 3 条；关键词命中 3 条；最终返回 2 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
  ...
  "hits": [
    {
      ...
      "metadata": {
        ...
        "embedding_model": "BAAI/bge-small-zh-v1.5",
        "embedding_dimensions": 512,
        "embedding_fingerprint": "sentence-transformers:BAAI/bge-sma...
```
