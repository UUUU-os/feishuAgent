...
```json
{
  "query": "飞书 AI 校园竞赛-主题分享直播-产品专场 飞书 AI 校园挑战赛-线上开赛仪式",
  "hits": [
    {
      ...
      "reason": "混合命中 final_score:0.762；向量召回:0.85；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛-线上开赛仪式；命中查询词:meetflow；包含回链定位",
      "score": 0.762,
      "vector_similarity": 0.851,
    ...
    },
    {
      ...
      "reason": "混合命中 final_score:0.708；向量召回:0.77；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛-线上开赛仪式；命中查询词:meetflow；包含回链定位；关键词召回:0.70；命中查询词:飞书；命中查询词:ai；命中查询词:校园挑战赛-线上开赛仪式；命中查询词:meetflow；包含回链定位",
      "score": 0.708,
      "vector_similarity": 0.768,
      "term_similarity": 0.696,
      "rerank_score": 0.0,
      "final_score": 0.708,
      "source_url": "https://bytedance.larkoffice.com/wiki/Eq0ywVPwdirCLakfBeucCwKWnoh",
  ...
  "reason": "混合检索候选 4 条；向量命中 3 条；关键词命中 3 条；最终返回 2 条；已过滤 embedding 不兼容文档 0 个、缺少指纹旧文档 5 个；namespace=sentence_transformers_baai_bge_small_zh_v1_5_512_137933ce；collection=meetflow_knowledge_chunks_137933ce"
}
```
