...
`python3 scripts/meetflow_cli.py demo-replay --all --write-report` 均通过或成功输出 JSON。
...
新增 `python3 scripts/meetflow_cli.py live sdk-callback`、`live worker`、`live d3-card`、
